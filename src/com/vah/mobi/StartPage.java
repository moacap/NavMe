...
public class StartPage extends Activity {
	LocationManager g,n;
    String cs,gString,dbase,sbase,ffurl,furl,murl="http://maps.google.com/staticmap?path=rgba%3A0xff000099%2Cweight%3A6",murl2="&zoom=16&size=800x800&key=YOUR_KEY_HERE";
    Context c=this;
    Location lkg,lkn,lk;
    Double d=0.0;
    Float s=0.0f; 
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        seep=(Button)this.findViewById(R.id.seep);
